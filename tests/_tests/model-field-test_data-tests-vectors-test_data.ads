...
package Model.Field.Test_Data.Tests.Vectors.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Model.Field.Vectors.Test_Data (Test);
...
end Model.Field.Test_Data.Tests.Vectors.Test_Data;
