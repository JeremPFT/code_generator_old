...
package body Model.Field.Object_T_Test_Data is

   --  Local_Object_T : aliased GNATtest_Generated.GNATtest_Standard.Model.Field.Object_T;
...
end Model.Field.Object_T_Test_Data;
