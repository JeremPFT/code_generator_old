...
package body Model.Enum_Value.Object_T_Test_Data is

   --  Local_Object_T : aliased GNATtest_Generated.GNATtest_Standard.Model.Enum_Value.Object_T;
...
end Model.Enum_Value.Object_T_Test_Data;
