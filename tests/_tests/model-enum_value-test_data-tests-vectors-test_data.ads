...
package Model.Enum_Value.Test_Data.Tests.Vectors.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Model.Enum_Value.Vectors.Test_Data (Test);
...
end Model.Enum_Value.Test_Data.Tests.Vectors.Test_Data;
