...
package String_Utils.Test_Data.Tests.U_String_Vectors.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.String_Utils.U_String_Vectors.Test_Data (Test);
...
end String_Utils.Test_Data.Tests.U_String_Vectors.Test_Data;
