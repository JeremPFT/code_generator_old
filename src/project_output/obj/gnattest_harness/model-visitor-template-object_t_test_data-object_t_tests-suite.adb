...
package body Model.Visitor.Template.Object_T_Test_Data.Object_T_Tests.Suite is

   package Runner_1 is new AUnit.Test_Caller
     (GNATtest_Generated.GNATtest_Standard.Model.Visitor.Template.Object_T_Test_Data.Object_T_Tests.Test_Object_T);
...
end Model.Visitor.Template.Object_T_Test_Data.Object_T_Tests.Suite;
--  end read only
