...
package Model.Types.Interface_Def.Test_Data.Tests.Vectors.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Model.Types.Interface_Def.Vectors.Test_Data (Test);
...
end Model.Types.Interface_Def.Test_Data.Tests.Vectors.Test_Data;
