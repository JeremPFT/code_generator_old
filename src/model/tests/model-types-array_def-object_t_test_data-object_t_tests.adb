...
--  placed into Model.Types.Array_Def.Object_T_Test_Data.
...
--  begin read only
--  end read only
package body Model.Types.Array_Def.Object_T_Test_Data.Object_T_Tests is
...
--  id:2.2/7393dd456fb38acf/Get_Contained_Type/1/0/
   ...
   --  model-types-array_def.ads:39:3:Get_Contained_Type
--  end read only
...
--  id:2.2/f6bc1657dfb458ea/Get_Index_Type/1/0/
   ...
   --  model-types-array_def.ads:44:3:Get_Index_Type
--  end read only
...
--  id:2.2/3e0bf790c7f56ca3/Get_Defined_Range/1/0/
   ...
   --  model-types-array_def.ads:49:3:Get_Defined_Range
--  end read only
...
--  id:2.2/aa247832a63b9c2c/Visit/1/0/
   ...
   --  model-types-array_def.ads:54:3:Visit
--  end read only
...
--  begin read only
--  end read only
end Model.Types.Array_Def.Object_T_Test_Data.Object_T_Tests;
