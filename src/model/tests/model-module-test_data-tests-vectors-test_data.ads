...
package Model.Module.Test_Data.Tests.Vectors.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Model.Module.Vectors.Test_Data (Test);
...
end Model.Module.Test_Data.Tests.Vectors.Test_Data;
