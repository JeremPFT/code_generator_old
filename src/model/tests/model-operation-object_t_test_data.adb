...
package body Model.Operation.Object_T_Test_Data is

   Local_Object_T : aliased GNATtest_Generated.GNATtest_Standard.Model.Operation.Object_T;
...
end Model.Operation.Object_T_Test_Data;
