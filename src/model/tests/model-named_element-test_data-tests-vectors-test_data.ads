...
package Model.Named_Element.Test_Data.Tests.Vectors.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Model.Named_Element.Vectors.Test_Data (Test);
...
end Model.Named_Element.Test_Data.Tests.Vectors.Test_Data;
