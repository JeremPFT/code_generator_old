...
--  begin read only
   procedure Test_Get_Owner_Class (Gnattest_T : in out Test_Object_T);
   procedure Test_Get_Owner_Class_415f19 (Gnattest_T : in out Test_Object_T) renames Test_Get_Owner_Class;
--  id:2.2/415f19df1ae91bab/Get_Owner_Class/1/0/
   procedure Test_Get_Owner_Class (Gnattest_T : in out Test_Object_T) is
   --  model-field.ads:39:3:Get_Owner_Class
--  end read only
...
--  begin read only
   procedure Test_Has_Default_Value (Gnattest_T : in out Test_Object_T);
   procedure Test_Has_Default_Value_40e05f (Gnattest_T : in out Test_Object_T) renames Test_Has_Default_Value;
--  id:2.2/40e05f543c879a5f/Has_Default_Value/1/0/
   procedure Test_Has_Default_Value (Gnattest_T : in out Test_Object_T) is
   --  model-field.ads:49:3:Has_Default_Value
--  end read only
...
--  id:2.2/3dfcf7b4dc6d3f03/Get_Default_Value/1/0/
   ...
   --  model-field.ads:54:3:Get_Default_Value
--  end read only
