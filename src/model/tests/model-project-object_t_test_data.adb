...
package body Model.Project.Object_T_Test_Data is

   Local_Object_T : aliased GNATtest_Generated.GNATtest_Standard.Model.Project.Object_T;
...
end Model.Project.Object_T_Test_Data;
