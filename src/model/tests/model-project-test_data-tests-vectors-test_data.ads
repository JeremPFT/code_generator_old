...
package Model.Project.Test_Data.Tests.Vectors.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Model.Project.Vectors.Test_Data (Test);
...
end Model.Project.Test_Data.Tests.Vectors.Test_Data;
