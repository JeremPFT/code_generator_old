...
package Model.Types.Enum_Value.Test_Data.Tests.Vectors.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Model.Types.Enum_Value.Vectors.Test_Data (Test);
...
end Model.Types.Enum_Value.Test_Data.Tests.Vectors.Test_Data;
