...
package body Model.Namespace.Object_T_Test_Data is

   Local_Object_T : aliased GNATtest_Generated.GNATtest_Standard.Model.Namespace.Object_T;
...
end Model.Namespace.Object_T_Test_Data;
